...
\noindent
In the remainder of this subsection, the bodies under discussion are bodies of assertion posits. Such a body is \emph{well-formed} when its assertions satisfy a set of mutually reinforcing properties. The first ensures that negated values and negative certainties are interchangeable:
